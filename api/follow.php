...
$user_id    = $_POST['user_id']; // User whose profile is being followed
$following_id = $_SESSION['user_id']; // User who is performing the follow action
$follower_id  = $_POST['user_id']; // User who is following the profile
